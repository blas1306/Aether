...
def _definitions() -> dict[str, BuiltinDefinition]:
    ...
    from .text import builtin_definitions as text_builtin_definitions
    ...
    for definition in [*core_builtin_definitions(), *io_builtin_definitions(), *text_builtin_definitions(), *linear_algebra_builtin_definitions(), *plot_builtin_definitions()]:
