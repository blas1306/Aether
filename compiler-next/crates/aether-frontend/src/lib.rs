...
pub use hir::{
    ...
    CoercionKind, CollectionIterationSource, DeclaredProgram, DefaultArgumentTemplate, EnumInfo,
    FieldInfo, FinallyId, FloatValue, FunctionId, FunctionInstanceInfo, FunctionSignature,
