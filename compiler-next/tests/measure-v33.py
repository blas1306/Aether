#!/usr/bin/env python3
"""V33 warm-cache snapshots using the eight V17 core phase boundaries.
...
Optional baseline binary must be built separately from the unmodified V32 tree.
"""
import argparse
import json
...
FIXTURES = (
    ...
    "programs/v33_rectangular.ae",
    "programs/v33_generic_int.ae",
    "programs/v33_generic_double.ae",
    "programs/v33_strided.ae",
    "programs/v33_both_transposed.ae",
    "programs/v33_zero_contraction.ae",
)
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aether-v33-timing-") as temp:
