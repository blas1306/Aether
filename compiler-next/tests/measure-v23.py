#!/usr/bin/env python3
"""V23 warm-cache snapshots using the eight V17 core phase boundaries.
...
Optional baseline binary must be built separately from the unmodified V22 tree.
"""
import argparse
import json
...
FIXTURES = (
    "v22_transpose_row.ae", "v23_matrix_row.ae", "v23_matrix_square.ae",
    "v23_matrix_rectangular.ae", "v23_matrix_loop.ae", "v23_matrix_owning.ae",
)
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aether-v23-timing-") as temp:
        artifact = Path(temp) / "artifact"
        if args.baseline_binary:
            report["v22_baseline"] = {
                "binary": str(args.baseline_binary.resolve()),
                "revision": args.baseline_revision,
                "fixture": "v22_transpose_row.ae",
                "timings": measure(args.baseline_binary, "v22_transpose_row.ae", args.runs, artifact),
            }
