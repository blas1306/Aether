#!/usr/bin/env python3
"""V31 warm-cache snapshots using the eight V17 core phase boundaries.
...
Optional baseline binary must be built separately from the unmodified V30 tree.
"""
import argparse
import json
...
FIXTURES = (
    ...
    "programs/v31_inner_int.ae",
    "programs/v31_inner_double.ae",
    "programs/v31_inner_strided.ae",
    "programs/v31_outer_concrete.ae",
    "programs/v31_outer_generic.ae",
    "programs/v31_outer_empty.ae",
)
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aether-v31-timing-") as temp:
