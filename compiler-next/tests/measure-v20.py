#!/usr/bin/env python3
"""V20 warm-cache snapshots using the eight V17 core phase boundaries.
...
Optional baseline binary must be built separately from the unmodified V19 tree.
"""
import argparse
import json
...
FIXTURES = (
    "v19_swap_remove_buffer.ae", "v20_remove_first.ae", "v20_remove_middle.ae",
    "v20_remove_last.ae", "v20_remove_buffer.ae", "v20_remove_nested.ae",
    "v20_remove_dataset.ae", "v20_remove_enum.ae", "v20_remove_reuse.ae",
)
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="aether-v20-timing-") as temp:
        artifact = Path(temp) / "artifact"
        if args.baseline_binary:
            report["v19_baseline"] = {
                "binary": str(args.baseline_binary.resolve()),
                "revision": args.baseline_revision,
                "fixture": "v19_swap_remove_buffer.ae",
                "timings": measure(args.baseline_binary, "v19_swap_remove_buffer.ae", args.runs, artifact),
            }
