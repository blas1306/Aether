...
| Funciones como parámetros o valores | No implementado en general | Resolver un diseño tipado sin closures obligatorias, o declarar formalmente un mecanismo callable equivalente. El caso especial de `Plots` no satisface este objetivo. |
...
| Módulos e imports | Solo AST | Importación de archivos, aliases, símbolos públicos, ciclos e inicialización deben tener semántica compilada y estrategia de link definida. |
