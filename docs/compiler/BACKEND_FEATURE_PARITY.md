...
| Interface dispatch class-carrier | Implemented | firma/conformidad | dispatch class | `interface_call`, slot/firma borrada | preserva efectos/ARC/panic | thunks + witness load + indirect call | receiver borrowed; mutación alias-visible | completion/symbols | Python/Rust/native O0/O1/O2 | Implemented 5.4B; boxing 5.4C pendiente |
